    ...
    return PopScope(
            ...
            Tab(
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 8),
                  Text(AppLocalizations.of(context)!.predictionParticipants),
                ],
              ),
            ),
            Tab(
      ...
      body: Consumer<SearchState>(
        builder: (context, state, _) {
          ...
          final topParticipants = List<UserModel>.from(list)
          ...
          return TabBarView(
            ...
            children: [
              ...
              _LeaderList(
                users: topParticipants.take(50).toList(),
                scoreKey: 'participant',
