            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  _tappbleText(context, '${state.userModel?.getFollower() ?? 0}',
                      ' Takipçiler', 'FollowerListPage'),
                  SizedBox(width: 10),
                  _tappbleText(context, '${state.userModel?.getFollowing() ?? 0}',
                      ' Takipler', 'FollowingListPage'),
                ],
              ),
            ),
          ],
